            ...
            <v-list-item>
                <v-list-item-content>
                    ...
                    <v-btn-toggle
                        ...
                        <v-btn class="caption" value="a1" height="40px" style="width: 30%">매매계약</v-btn>
                        <v-btn class="caption" value="a2" height="40px" style="width: 30%">전세계약</v-btn>
                        <v-btn class="caption" value="a3" height="40px" style="width: 30%">월세계약</v-btn>
                    </v-btn-toggle>
                </v-list-item-content>
            </v-list-item>
            ...
            <v-list-item>
                <v-list-item-content>
                    ...
                    <v-btn-toggle
                        ...
                        <v-btn class="caption" value="b2" height="40px" style="width: 45%">오피스텔</v-btn>
                        <v-btn class="caption" value="b3" height="40px" style="width: 90%">주택이외(토지, 상가 등)</v-btn>
                    </v-btn-toggle>
                </v-list-item-content>
            </v-list-item>
